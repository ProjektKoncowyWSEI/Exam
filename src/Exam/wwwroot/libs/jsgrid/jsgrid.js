...
MyDateField.prototype = new jsGrid.Field({
    ...
    insertTemplate: function (value) {
        return this._insertPicker = $("<input type='datetime-local'>")//.datepicker({ defaultDate: new Date() });
    },

    editTemplate: function (value) {
        return this._editPicker = $("<input type='datetime-local'>")//.datepicker().datepicker("setDate", new Date(value));
    },
